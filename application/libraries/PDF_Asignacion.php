...
class PDF_Asignacion extends FPDF
{
    ...
    public function Header()
    {
        ...
        $this->Text(112, 10, 'POLICIA NACIONAL CIVIL');
        $this->SetFont('Arial', 'B', 10);
        $this->Text(90, 15, 'Recibo  de '.$this->tipoDocumento.' de Mobiliario y Equipo Institucional');
        $this->SetFont('Arial', '', 8);
        $this->Text(228, 8, 'Pag. '.$this->PageNo().' de {nb}');
        $this->Text(228, 12, 'IMPRESO EL : '.date('d/m/Y'));
        ...
        $this->Text(220, 29, 'Documento No. ');
        $this->Text(220, 25, 'Fecha Crea: ');
        $this->SetFont('Arial', 'B', 9);
        $this->Text(240, 25, $this->fecha);
        $this->Text(240, 29, $this->numDocumento);
        $this->SetFont('Arial', '', 8);
