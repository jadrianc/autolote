...
class PDF_Rep_SinDecomisos extends FPDF
{
    public $widths;
    public $aligns;
    public $title;
    ...
    public function Header()
    {
        ...
        $this->Text(70, 17, utf8_decode('DETALLE DE ESQUELAS SIN DECOMISOS REMITIDAS CON OFICIO N° '.$this->data['NUM_OFICIO'])." ". $fecha);
       ...
       // $this->Text(15, 49, 'DEPARTAMENTO DE SUMINISTROS');
        ...
        $this->Cell(13,$altoEncab,'ID',1,0,'C');
        $this->Cell(19,$altoEncab,'SERIE',1,0,'C');
        $this->Cell(30,$altoEncab,'LICENCIA',1,0,'C');
        $this->Cell(63,$altoEncab,'NOMBRE',1,0,'C');
        $this->Cell(22,$altoEncab,'PLACA',1,0,'C');
        $this->Cell(30,$altoEncab,'CLASE',1,0,'C');
        $this->Cell(13,$altoEncab,'RUTA',1,0,'C');
        $this->Cell(15,$altoEncab,'FALTA',1,0,'C');
        $this->Cell(20,$altoEncab,'FECHA',1,0,'C');
        $this->Cell(15,$altoEncab,'HORA',1,0,'C');
        $this->Cell(15,$altoEncab,'ONI',1,0,'C');
        $this->SetY(35);
...
{  
    ...
    {
        return new PDF_Rep_SinDecomisos();
    }
}
