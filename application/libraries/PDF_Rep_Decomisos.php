...
class PDF_Rep_Decomisos extends FPDF
{
    public $widths;
    public $aligns;
    public $title;
    ...
    public function Header()
    {
        ...
        $this->Text(70, 17, utf8_decode('DETALLE DE ESQUELAS CON DECOMISOS REMITIDAS CON OFICIO N° '.$this->data['NUM_OFICIO']). " ". $fecha);
       ...
       // $this->Text(15, 49, 'DEPARTAMENTO DE SUMINISTROS');
        ...
        $this->Cell(35,$altoEncab,'TIPO DE DOCUMENTO',1,0,'C');
        $this->Cell(35,$altoEncab,utf8_decode('N° DE DOCUMENTO'),1,0,'C');
        $this->Cell(70,$altoEncab,'PROPIETARIO',1,0,'C');
        $this->Cell(30,$altoEncab,'FALTA',1,0,'C');
        $this->Cell(30,$altoEncab,'SERIE',1,0,'C');
        $this->Cell(30,$altoEncab,'FECHA',1,0,'C');
        $this->Cell(30,$altoEncab,'ONI',1,0,'C');
