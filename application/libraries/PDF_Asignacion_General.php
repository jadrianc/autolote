...
class PDF_Asignacion_General extends FPDF
{
    public $widths;
    public $aligns;
    public $title;
    ...
    public function Header()
    {
        ...
        $this->Text(145, 20, 'DEPARTAMENTO DE ATIVO FIJO');
        $this->Text(141, 30, $this->tipoDocumento);

        $this->SetFont('Arial', '', 8);
        $this->Text(12, 37, 'FECHA : '.date('d/m/Y'));

        $this->Text(45, 37,'UNIDAD: ');
        $this->Text(78, 37, trim($this->cCosto->NOM_COS));
        $this->Text(175, 37,'ASIGNADO A: ');
        ...
        $this->Cell(25,$altoEncab,'VALOR',1,0,'C');
        $this->Cell(25,$altoEncab,'FECHA ASIG.',1,0,'C');
        $this->Cell(25,$altoEncab,'TIPO MOV.',1,0,'C');
        $this->Cell(30,$altoEncab,'NO DOCUMENTO',1,0,'C');
    ...
    {
        return new PDF_Asignacion_General();
    }
}
